...
public class checkhotels extends JFrame implements Runnable{
    ...
    public void run(){
        String [] text = new String[]{"Jw Marriot Hotel","Mandarin Orientel Hotel","Four Seasons Hotel","Radissons Blue Hotel","Classio Hotel","The Bay Club Hotel","Breeze Blow Hotel","The Taj Hotel","Happy Morning Motel","River View Hotel"};
        try{
            for(int i=0;i<=9;i++){
    ...
    checkhotels(){
        ...
        captions.setFont(new Font("Tahuma",Font.PLAIN,40));
        captions.setForeground(new Color(0xFFFFFF));
        add(captions);
